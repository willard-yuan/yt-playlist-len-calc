        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-light mt-6">
              Practical, no-fluff tutorials for calculating playlist length, planning your watch time, and getting the most out of YouTube — written by the tool&apos;s creator.
            </p>
          </div>
        </div>
      </div>
