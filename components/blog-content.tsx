...
export function BlogContent({ locale }: { locale: Locale }) {
  ...
  // SubpageKey is a literal union; blog.posts.<slug>.* keys are dynamic by slug.
        ...
        <div className="max-w-5xl mx-auto">
                ...
                <div className="md:flex items-stretch">
                  ...
                  <div className="md:w-3/5 p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-4 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                      <LocaleLink href={`/blog/${post.slug}`} className="focus:outline-none">
          ...
          <div className="text-center py-24">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold mb-4">{subT("blog.moreComing.title")}</h3>
              <p className="text-muted-foreground text-lg leading-relaxed">
                {subT("blog.moreComing.body")}
              </p>
            </div>
          </div>
        </div>
