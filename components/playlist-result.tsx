                    ...
                    <Card className="p-4 bg-gray-50 dark:bg-gray-800/50 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                            <div className="text-center">
                                <p className="font-bold text-lg text-purple-600">{playlistStats.daysToComplete}</p>
                                <p className="text-muted-foreground">Days (2hrs/day)</p>
                            </div>
                            <div className="text-center">
                                <p className="font-bold text-lg text-purple-600">{Math.ceil(playlistStats.watchingHours / 8)}</p>
                            ...
                            <div className="text-center">
                                <p className="font-bold text-lg text-purple-600">{avgLength}</p>
